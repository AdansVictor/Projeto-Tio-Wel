<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroCliente.aspx.cs" Inherits="WebApplication1.ProjetoLanchonete.CadastroCliente" %>
...
<body class="home">
    ...
    <section style="background-image: url('../img/hh.jpeg');" class="item">
            ...
            <div class="col-md-12">
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox placeholder="Digite seu nome Completo" CssClass="form-control" runat="server" ID="nomeComp" />
                    </div>

                    <div class="form-group">
                        <%--<label>Digite seu CPF:</label>--%>
                        <asp:TextBox placeholder="Digite seu CPF" CssClass="form-control" runat="server" ID="txtcpf" />
                    </div>

                    <div class="form-group">
                        <%--<label>Digite seu Endereço:</label>--%>
                        <asp:TextBox placeholder="Digite seu Endereço" CssClass="form-control" runat="server" ID="txtEndereco" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox placeholder="Digite sua Data de Nascimento" runat="server" CssClass="form-control" ID="txtNac" />
                    </div>

                    <div class="form-group">
                        <asp:Button ID="btnGravar" runat="server" OnClick="btnGravar_Click" CssClass="form-control btn btn-success" Text="Gravar Usuário" />
                        <asp:TextBox runat="server" placeholder="Resultado do Cadastro" CssClass="form-control" ID="resultado" />
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="post">
                        <div class="image"><a href="text.html">
                            <img src="../img/ee.jpeg" alt="" class="img-responsive" /></a></div>
                ...
                <div class="col-sm-6">
                    <div class="post">
                        <div class="image"><a href="text.html">
                            <img src="../img/dd.jpeg" alt="" class="img-responsive" /></a></div>
