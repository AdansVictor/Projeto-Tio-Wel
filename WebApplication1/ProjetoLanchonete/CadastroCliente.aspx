...
<head>
 ...
 <!-- navbar-->
   ...
   <form id="form1" runat="server">
            ...
            <asp:TextBox CssClass="form-control" runat="server" id="nomeComp"/>
            </div>

            <div class ="form-group">
            <label>Digite seu CPF:</label><asp:TextBox  CssClass="form-control" runat="server" id="txtcpf"/>
             </div>

                <div class ="form-group">
            <label>Digite seu Endereço:</label><asp:TextBox CssClass="form-control" runat="server" id="txtEndereco"/>
                </div>

                <div class ="form-group">
            <label>Digite seu Telefone:</label><asp:TextBox runat="server" CssClass="form-control" id="txtTel"/>
                </div>


                <div class ="form-group">
            <label>Digite sua Data de Nascimento:</label><asp:TextBox runat="server" CssClass="form-control" id="txtNac"/>
                 </div>

                    <div class ="form-group">
            <asp:Button ID="btnGravar" runat="server" OnClick="btnGravar_Click" CssClass="form-control btn btn-success" Text="Gravar Usuário" />
            <asp:TextBox runat="server" CssClass="form-control" id="resultado"/>
                    </div>
    </form>
                </div>
                     </div>
    ...
    <section class="section--padding-bottom-small">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="post">
              <div class="image"><a href="text.html"><img src="../img/ee.jpeg" alt="" class="img-responsive" /></a></div>
